...
class CustomAdapter(poolInfoData: PoolInfoData, stringArray: Array<String>) :
    ...
    init {
        if (poolInfoData.errorCode > 0) {
            ...
            dataArray = arrayOf(
                stringArray[0] + poolInfoData.t1.toString(),
    ...
    class ViewHolder(viewBinding: PoolInfoTextViewBinding) :
